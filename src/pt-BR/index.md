...
description: Um guia sem enrolação sobre concorrência em Swift. Aprenda async/await, actors, Sendable e MainActor com modelos mentais claros. Sem jargão, apenas explicações compreensíveis.
lang: pt-BR
dir: ltr
nav:
...
<section class="hero">
  <div class="container">
    ...
    <p class="subtitle">Finalmente entenda async/await, actors e Sendable. Modelos mentais claros, sem jargão.</p>
    ...
    <p class="cta-tuist">Escale seu desenvolvimento com <a href="https://tuist.dev">Tuist</a></p>
  </div>
</section>
...
**Mas aqui está a boa notícia:** Uma vez que você entenda o [isolamento](#basics) (5 min de leitura), tudo faz sentido. Os erros do compilador começam a fazer sentido. Você para de lutar contra o sistema e começa a trabalhar com ele.
...
**[Isolamento](https://www.massicotte.org/intro-to-isolation/)** é a chave para tudo. É a resposta do Swift à pergunta: *Quem tem permissão para tocar nesses dados agora?*
...
Swift e Rust oferecem as garantias mais fortes em tempo de compilação contra data races. Kotlin Coroutines oferece concorrência estruturada similar ao async/await do Swift, mas sem o mesmo nível de enforcement no sistema de tipos para thread safety. O trade-off? Uma curva de aprendizado mais íngreme no início. Mas uma vez que você entende o modelo, o compilador te protege.
...
- **A recepção** (`MainActor`) - onde todas as interações com clientes acontecem. Só existe uma, e ela lida com tudo que o usuário vê.
- **Escritórios de departamento** (`actor`) - contabilidade, jurídico, RH. Cada departamento tem seu próprio escritório protegendo seus próprios dados sensíveis.
- **Corredores e áreas comuns** (`nonisolated`) - espaços compartilhados por onde qualquer um pode passar. Sem dados privados aqui.
</div>
